// Copied from datafusion-cli's main.rs and adapted to inject
// our custom catalog provider.
...
use catalog_provider::CStoreCatalogProvider;
use clap::Parser;
...
pub async fn main() -> Result<()> {
    ...
    match ctx {
        Context::Local(ref session_context) => {
            session_context.register_catalog(
                "splitgraph",
                Arc::new(CStoreCatalogProvider {
